...
We are pleased to announce the release of [Stash v2025.7.31](https://stash.run/docs/v2025.7.31/setup/), packed with major improvements. You can check out the full changelog [HERE](https://github.com/stashed/CHANGELOG/blob/master/releases/v2025.7.31/README.md). In this post, we'll highlight the changes done in this release.
